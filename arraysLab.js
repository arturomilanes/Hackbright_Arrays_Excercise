...
console.log("fist Item is " + firstItem);
...
sampleArray.push(42);
console.log("new sample array with push is " + sampleArray);
...
sampleArray.pop();
console.log("new sample array with pop is " + sampleArray);
...
console.log("new sample array is " + sampleArray);
